...
public class ChatMessage {
    public static MutableText brandmessage() {
        return (MutableText) TextHelper.applyPredefinedGradient("RIch(onlyVisualCrackByFolof(NOTCHETA!!!!)", "black_light_purple", true);
    }
    ...
    public static MutableText autobuy() {
        return (MutableText) TextHelper.applyPredefinedGradient("Auto Buy not work", "black_light_purple", true);
    }
    ...
    public static void brandmessage(String message) {
        if (MinecraftClient.getInstance().player != null) {
            Text prefix = TextHelper.applyPredefinedGradient("RIch(onlyVisualCrackByFolof(NOTCHETA!!!!) -> ", "black_light_purple", true);
